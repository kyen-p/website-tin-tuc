...
const MOCK_DATA = {
  ...
  site: {
    ...
    short_description:
      "Bắt mạch dòng chảy tin tức Việt Nam - cập nhật liên tục, xác thực trước khi đăng.",
    social_links: {
  ...
  users: [
    {
      ...
      bio: "Độc giả trung thành của Mạch Tin.",
      role: "user",
      status: "active",
    ...
    },
    {
      id: 5,
      username: "reporter01",
      email: "reporter01@gmail.com",
      password: "12345678",
      full_name: "Thanh Ngân",
      date_of_birth: "2000-05-10",
      phone: "0901000555",
      avatar: "/assets/images/avatar-5.png",
      bio: "Phóng viên mảng công nghệ, giáo dục và thể thao.",
      role: "reporter",
      status: "active",
      comment_locked: false,
    },
    ...
    },
    {
      ...
      password: "12345678",
      full_name: "Lê Biên Tập",
      date_of_birth: "1997-07-15",
      phone: "0901000777",
      avatar: "/assets/images/avatar-7.png",
      bio: "Biên tập viên nội dung của Mạch Tin.",
      role: "editor",
      status: "active",
      comment_locked: false,
    },
  ...
  categories: [
    {
      ...
      name: "Thời sự",
      slug: "thoi-su",
      description: "Tin tức thời sự trong nước.",
    },
    {
      id: 2,
      name: "Công nghệ",
      slug: "cong-nghe",
      description: "Công nghệ, AI, chuyển đổi số.",
    },
    {
      id: 3,
      name: "Thể thao",
      slug: "the-thao",
      description: "Tin thể thao trong nước và quốc tế.",
    },
    {
      id: 4,
      name: "Giải trí",
    ...
    },
    {
      ...
      name: "Đời sống",
      slug: "doi-song",
      description: "Câu chuyện đời sống, xã hội.",
    },
    {
      id: 6,
      name: "Giáo dục",
      slug: "giao-duc",
      description: "Tin giáo dục, đào tạo.",
    },
  ],
  ...
  articles: [
    {
      ...
      short_description:
        "Nhiều trường đại học bắt đầu đưa AI vào giảng dạy và đánh giá.",
      content:
        "Nội dung đầy đủ bài AI trong giảng đường... (đoạn 1)\n\nNội dung đầy đủ bài AI trong giảng đường... (đoạn 2)",
    ...
    },
    {
      ...
      short_description:
        "Giá vàng miếng sáng 12/8 vượt mọi dự báo của chuyên gia.",
      content:
        "Nội dung đầy đủ bài giá vàng... (đoạn 1)\n\nNội dung đầy đủ bài giá vàng... (đoạn 2)",
      ...
      rejection_reason: null,
      view_count: 450,
      published_at: "2026-08-12 07:30:00",
      created_at: "2026-08-12 06:00:00",
      updated_at: "2026-08-12 07:30:00",
    },
    {
      id: 3,
      ...
      content:
        "Nội dung đầy đủ bài SEA Games... (đoạn 1)\n\nNội dung đầy đủ bài SEA Games... (đoạn 2)",
    ...
    },
    {
      ...
      topic_id: null,
      rejection_reason:
        "Thiếu nguồn trích dẫn và ảnh bản quyền. Bổ sung rồi gửi duyệt lại.",
      view_count: 0,
      published_at: null,
    ...
    },
    {
      ...
      view_count: 0,
      published_at: null,
      created_at: "2026-08-12 07:00:00",
      updated_at: "2026-08-12 07:30:00",
    },
    {
      id: 9,
      title: "Góc cà phê yên tĩnh giữa Sài Gòn",
  ...
  comments: [
    {
      ...
      article_id: 2,
      user_id: 1,
      content: "Tin hữu ích, cảm ơn tòa soạn.",
      is_deleted: false,
    ...
    },
    {
      ...
      article_id: 2,
      user_id: 3,
      content: "Giá vàng tăng nhanh quá.",
      is_deleted: false,
      created_at: "2026-08-12 09:00:00",
      updated_at: "2026-08-12 09:00:00",
    },
    {
      ...
      article_id: 1,
      user_id: 2,
      content: "Vào link nhận thưởng... (bình luận spam)",
      is_deleted: false,
    ...
    },
    {
      ...
      article_id: 1,
      user_id: 1,
      content: "Nội dung dễ hiểu, mong có thêm bài về AI.",
      is_deleted: false,
    ...
    },
    {
      ...
      article_id: 3,
      user_id: 3,
      content: "Chúc đội tuyển thi đấu tốt!",
      is_deleted: false,
    ...
    },
    {
      ...
      article_id: 4,
      user_id: 1,
      content: "Cuối tuần nhất định phải đi.",
      is_deleted: false,
  ...
  notifications: [
    ...
    },
    {
      ...
      content:
        'Bài "Phim Việt ra rạp mùa lễ hội" bị từ chối: Thiếu nguồn trích dẫn và ảnh bản quyền.',
      link: "/reporter/my-articles.html",
      is_read: false,
      created_at: "2026-08-11 10:00:00",
    },
    {
      ...
      content:
        'Bài "Đội tuyển Việt Nam chốt danh sách dự SEA Games" đã được đăng.',
      link: "/reporter/my-articles.html",
      is_read: false,
      created_at: "2026-08-11 09:00:00",
    },
  ...
  topics: [
    ...
    {
      id: 2,
      title: "Chuyển đổi số ở doanh nghiệp nhỏ",
    ...
    {
      id: 3,
      title: "AI trong giảng đường đại học",
