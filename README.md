...
**Giai đoạn 1:** Dựng khung Giao diện tĩnh (HTML/CSS) - **Deadline: hết ngày 09/08/2026**
  * `public/`: Trang công khai (Cặp 1)
  * `user/`: Trang người dùng & Phóng viên (Cặp 2)
  * `admin/`: Trang quản trị & Biên tập (Cặp 3)
