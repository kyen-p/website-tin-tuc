...
PHÂN HỆ: Đăng nhập & Xác thực người dùng
MÔ TẢ: Xử lý giao diện và đăng nhập vào hệ thống:
       - Kiểm tra tính hợp lệ dữ liệu form (username/email, password)
       - Gọi API backend/api/auth/login.php
       - Hiển thị thông báo khi tài khoản bị khóa hoặc sai mật khẩu
       - Điều hướng người dùng theo phân quyền (Admin, Editor, Reporter, Độc giả)
PHẠM VI SỬ DỤNG:
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Nếu người dùng đã đăng nhập từ trước, tự động chuyển về trang phù hợp
    ...
    // Xóa cảnh báo lỗi khi người dùng bắt đầu gõ lại
...
// Chuyển hướng người dùng dựa theo vai trò tài khoản
