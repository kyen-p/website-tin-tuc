/**
 * editor-categories-tags.js - Quản lý Chuyên mục & Tag tối giản, thông minh cho Ban Biên tập
 * Bám sát 100% nghiệp vụ đã thống nhất:
 * 1. QUẢN LÝ CHUYÊN MỤC:
 *    - Xem danh sách chuyên mục kèm số lượng bài viết (published + pending + draft + rejected).
 *    - Thêm chuyên mục mới (Tên, Slug tự động, Mô tả).
 *    - Sửa tên & mô tả chuyên mục.
 *    - Xóa chuyên mục: Khóa / chặn xóa nếu số bài viết > 0 ("Chuyên mục còn X bài viết, không thể xóa để bảo toàn dữ liệu"). Cho phép xóa khi số bài = 0.
 * 2. QUẢN LÝ THẺ (TAGS):
